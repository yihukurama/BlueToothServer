...
package com.yihukurama.bluetoothserver.controler.bluetooth;
...
public class BluetoothService {
    ...
    private class ServerThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (tempString.equals("StartOnNet\n")) {
                    ...
                    mOutputStream.write("bb".getBytes());
                    mOutputStream.flush();
                }
        ...
        public static final byte[] getSocketResult(InputStream inStream)
        throws IOException {
